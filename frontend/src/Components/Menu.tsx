...
export function MenuSeparator(props: SeparatorProps) {
  return (
    <Separator
      {...props}
      className="mx-3 my-1 border-b border-neutral-700"
    />
  );
}
...
export function MenuSection<T extends object>(props: MenuSectionProps<T>) {
  return (
    ...
    >
      {props.title && (
        <Header className="text-sm font-semibold text-neutral-300 px-4 py-1 truncate sticky -top-[5px] -mt-px -mx-1 z-10 bg-neutral-700/60 backdrop-blur-md supports-[-moz-appearance:none]:bg-neutral-100 border-y border-y-neutral-700 [&+*]:mt-1">
          {props.title}
        </Header>
      )}
