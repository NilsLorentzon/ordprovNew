      ...
      <div className=" rounded-md p-4 m-auto shadow-md border border-black/20 bg-white max-w-2xl">
        ...
        <div className="mb-4">
          ...
          <div className="">
            <p className="tracking-wide text-lg mb-2">
              ...
              <a
                href="mailto:nils.lorentzon@hotmail.com"
                className="text-p-400 underline"
              >
                nils.lorentzon@hotmail.com
              </a>
              .
            </p>
          </div>
        ...
        <div className="mb-4">
          ...
          <div className="">
            ...
            <p className="tracking-wide text-lg mb-2">
              Vill man stödja hemsidan så kan man swisha valfritt belopp till{" "}
              <a
                href="https://www.swish.nu/"
                className="text-p-400 underline text-nowrap"
                target="_blank"
              >
                123 456 7890
              </a>{" "}
